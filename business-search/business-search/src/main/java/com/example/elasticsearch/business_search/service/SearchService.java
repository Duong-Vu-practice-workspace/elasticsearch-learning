package com.example.elasticsearch.business_search.service;

import co.elastic.clients.elasticsearch._types.aggregations.StringTermsAggregate;

import com.example.elasticsearch.business_search.dto.*;
import com.example.elasticsearch.business_search.util.Constants;
import com.example.elasticsearch.business_search.util.NativeQueryBuilder;
...
import static com.example.elasticsearch.business_search.util.Constants.Business.OFFERINGS_AGGREGATE_NAME;
